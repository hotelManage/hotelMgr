...
<script src='<%=basePath%>asset/script/base/jquery-1.11.1.min.js'	type='text/javascript'></script>
...
<script src='<%=basePath%>asset/script/base/jquery.artDialog.js'	type='text/javascript'></script>

<script src='<%=basePath%>asset/script/base/json2.js' type='text/javascript'></script>
